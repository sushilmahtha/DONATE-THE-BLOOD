			...
			<div class="row">
				<div class="col-md-12 col-md-push-1">
					<div class="panel panel-default" style="padding: 20px;">
						...
						<?php 
							$safeData=$_SESSION['save_life_date'];	
							if($safeData == '0'){
								echo '
								<form target=" " method ="post">
								...
								if($diffMonth>=3){
									...
									<span>You already saved life, You will donate after three months, we are thankfull to you.</span>
									</div>
									';	
								}
